# Restricciones Técnicas y del Sistema

Condiciones y limitaciones obligatorias que deben respetarse durante el diseño y construcción de la solución.

| ID | Restricción | Descripción |
| :--- | :--- | :--- |
| **RC01** | **Aplicación Web** | El sistema debe ser una aplicación orientada a la web accesible desde cualquier navegador estándar. |
| **RC02** | **Control de Versiones** | El código fuente y la documentación deben gestionarse de forma obligatoria mediante Git y compartirse en GitHub. |
